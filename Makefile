...
source/motmot-modules.pdf: source/motmot.dot
	cat $< | dot -Tpdf -o$@
...
source/graph.png source/graph.map: source/motmot.dot
	cat $< | dot -Tcmap -osource/graph.map -Tpng:cairo -osource/graph.png
...
latex: source/motmot-modules.png
#latex: source/motmot-modules.pdf
